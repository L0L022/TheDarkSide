...
cp ../main.bash ../autostart/check_version.bash ../autostart/update.bash ../the_dark_side.bash ../desktop/wallpaper_cli.png ../desktop/linux_tux_by_linux4sa.jpg home_copy/.cache/the_dark_side/
